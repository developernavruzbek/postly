...
class User(
    ...
    @Enumerated(value=EnumType.STRING) @Column(nullable = false) var accountType :AccountType = AccountType.PUBLIC,
    var bio:String?,
...
class UserFollow(
    ...
    @Enumerated(value = EnumType.STRING) var status: FollowStatus = FollowStatus.PENDING
):BaseEntity()